...
import { camelToDelimiter, setTabs } from "./utils";

export const parser = (schema: string) => {
  ...
  //   const queries = definitions.find(
  //     (item: DefinitionNode) => item.name.value === "Query"
  //   );
...
//   current: DefinitionNode | null = null,
//   title = "query"
// ) => {
//   let query = {};
